        ...
        <div className="home-container">
            <div className="home-container-content">
                ...
                <div className="bottom-container">
                    ...
                    The whole app is <span>Dockerized</span> in <span>Ubuntu 18.04</span> and both the development start-up and deployment to <span>AWS</span> is fully automated by <span>bash</span> scripts. You can view the source code <a href="https://github.com/michaelbauerinc/portfolio" rel="noopener noreferrer" target="_blank"><span>here.</span></a></p>
                </div>
            </div>
        </div>
    )
